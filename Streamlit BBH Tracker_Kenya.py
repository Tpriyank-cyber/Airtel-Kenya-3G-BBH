    ...
    if None in [cs1, cs2, ps1, ps2, mapa1, mapa2]:
        ...
        try:
            ...
            mapping = {
                ...
                'csrrcsetupsuccessratenom': 'CS RRC Setup Success Rate _NUM',
                'csrrcsetupsuccessratednom': 'CS RRC Setup Success Rate _DENUM',
                'psrrcsetupsuccessratenom': 'PS RRC Setup Success Rate _NUM',
                'psrrcsetupsuccessratednom': 'PS RRC Setup Success Rate _DENUM',
